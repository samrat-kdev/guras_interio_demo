    ...
    <section className="bg-[#F5F5F5] py-16 px-6 md:px-16">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="w-full md:w-1/2 mt-8 md:mt-0 md:pl-12">
          ...
          {/* CTA Button */}
          <Link2 href="/contact" className="mt-8 px-6 py-3 bg-[#6b1b55] text-white text-lg font-medium uppercase rounded-md hover:bg-[#7D1C4A] transition-all">You Can Contact Us </Link2>
